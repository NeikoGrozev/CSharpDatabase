        ...
        static void Main()
        {
            ...
            using (connection)
            {
                try
                {
                    ...
                    SqlCommand command = new SqlCommand(createDb, connection);
            ...
            using (connection)
            {
                ...
                string insertInTable = @"INSERT INTO Countries ([Name]) VALUES ('Bulgaria'),('England'),('Cyprus'),('Germany'),('Norway')
                ...
                try
                {
                    SqlCommand commandInsert = new SqlCommand(insertInTable, connection);
